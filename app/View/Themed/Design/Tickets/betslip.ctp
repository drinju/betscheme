        ...
        <div class="tab-content">
            ...
            <div role="tabpanel" class="tab-pane active" id="<?php if(count($bets) == 1):?>betslip-single<?php else:?>betslip-multi<?php endif;?>">
                ...
                <div class="stake reall rem1">
                    <div class="stake-top">
                        <a onclick="Ticket.removeBet(<?php echo $bet['BetPart']['id']; ?>, $(this));" href="#real2" class="remove" id="rem1"></a>
            ...
            <?php else: ?>
                <div role="tabpanel" class="tab-pane active" id="betslip-information">
                    <div class="stake reall rem1">
                        ...
                        <?php if(isset($bets) AND is_array($bets) AND !empty($bets)): ?>
                        <?php else: ?>
                            <div style="margin-top: 5px; font:13px 'Fira Sans',Arial,Helvetica,sans-serif;"><?php echo __('No bet has been selected. To select a bet, please click on the respective result.'); ?></div>
                        <?php endif; ?>
                        <div class="clear"></div>
                    </div>
                    <div id="bestlip_errors" class="error-log ">
