...
<div id="sidebar" class="nav-collapse collapse">
    ...
    <center>
        <a href="http://docs.betscheme.com/" target="_blank"> <img src="/theme/Admin/img/doc.png" alt="Betscheme documentation" width="50" height="50" border="0"></a>
        <a href="http://docs.betscheme.com/faq.php" target="_blank"><img src="/theme/Admin/img/faq.png" alt="Betscheme faq" width="50" height="50" border="0"></a>
    </center>
    <!-- END SIDEBAR MENU -->
</div>