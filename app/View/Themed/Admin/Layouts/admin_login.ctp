...
<div id="login">
    <div class="alert alert-info">
        ...
        For logins to adminstration panel please use as <font color="red">user admin and same as password admin.</font>  If you have issues or questions please contact our support team:<br><br>
        <strong>Skype:</strong> <span>sportsbookprojectmanager<span><br>
        <strong>Email:</strong> <span>info@betscheme.com</span><br>
		<strong>Mobile:</strong> <span>+370 67 031 965 Mobile|Viber|Whatsapp</span>
    </div>
